...
#Bono final
bono = var_4*3 - 0.1*var_4

#Poniendo los datos en un diccionario
dic = {"nombre": var_1, "apellido paterno": var_2, "distrito": var_3, "bono final": bono}

#Asignando nuevas variables a mi lista
nombre, apellido_paterno, distrito, bono_final = dic["nombre"], dic["apellido paterno"], dic["distrito"], dic["bono final"]
